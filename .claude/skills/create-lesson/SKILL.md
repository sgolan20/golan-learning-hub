---
name: create-lesson
description: יצירת דף תרגול/שיעור חדש למרכז הלמידה. השתמש ב-skill הזה כשהמשתמש מבקש ליצור דף שיעור, דף תרגול, או דף עבודה חדש לקורס.
---
...
- כשהמשתמש מבקש ליצור "דף שיעור", "דף תרגול", "דף עבודה" חדש
- כשהמשתמש נותן HTML של דף ומבקש להוסיף אותו לקורס
- כשהמשתמש מבקש להוסיף תוכן חדש לקורס קיים
